...
X_train=pd.read_csv(r'G:/Downloads/Research/Antioxidative_Peptides/Predicting-Probability/PP_train.csv').iloc[:,1:].values

#Import testing/independent file
X_test=pd.read_csv(r'G:/Downloads/Research/Antioxidative_Peptides/Predicting-Probability/PP_Ind.csv').iloc[:,1:].values

#Training dataset labels
pos_labels = np.ones(514)
neg_labels = np.zeros(514)
y_train = np.concatenate((pos_labels,neg_labels),axis=0)


#Testing dataset labels
pos_labels2 = np.ones(128)
neg_labels2 = np.zeros(128)
